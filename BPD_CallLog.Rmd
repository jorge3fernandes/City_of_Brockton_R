...
links4 <- paste0(prefix, format(AllDays, '%Y/%m/'), format(as.mondate(AllDays)-1,"%m%d%y"),'.pdf')

links <- data.frame(links1,links2,links3,links4)
links$links1 <-as.character(links$links1) 
links$links2 <-as.character(links$links2) 
links$links3 <-as.character(links$links3) 
links$links4 <-as.character(links$links4) 
```
