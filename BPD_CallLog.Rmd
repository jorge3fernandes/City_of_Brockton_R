...
Brocktonmap <- leaflet() %>% 
  ...
  addCircleMarkers(-71.02016, 42.08667,  popup = 'City Of Champions', radius = 5, color = 'red')

Brocktonmap %>% 
  addTiles() %>% 
  setView(-71.02016, 42.08667, zoom = 13) %>% 
  addMarkers(data = testdata, lng = ~long, lat = ~ lat, colorFactor = ~ ifelse(!is.na(Arrested), 'red', 'blue'), popup = testdata$call_reason_action)
Brocktonmap
